...
class _WorkWebState extends ConsumerState<WorkWeb> {
  ...
  Widget build(BuildContext context) {
    final showHeadline = ref.watch(article1Provider);
    // print('hey:${showHeadline.article1?.articleTitle}');
    return Column(
      children: [
        RichText(
          text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text: '${showHeadline.article1?.projectHeadline}',
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child:
                          Image.network('${content?.articleImage?.filename}'),
                    ),
                  ),
                ],
              ),
